...
AP_Show_SSD1306_SPI::AP_Show_SSD1306_SPI(AP_Show &show)
...
void
AP_Show_SSD1306_SPI::_refresh()
{
  SSD1306_UpdateScreen();
}

void
AP_Show_SSD1306_SPI::show(uint8_t* str, uint8_t x_pos, uint8_t y_pos)
{
...
void
AP_Show_SSD1306_SPI::show(uint8_t page_num)
{
  uint8_t y_pos = 0;
